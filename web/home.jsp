    ...
    #menu:hover{
       background-color: rgb(182 , 181  , 181) 
        ...
        .popup-content {
            ...
            width: 90%;
            max-width: 700px;
            border-radius: 2cap solid black;
            text-align: left;
            position: relative;
...
<body style="background-color : rgb(213, 216, 220);">
    ...
    <div class="min-h-screen flex">
        ...
        <nav class="flex flex-col w-full px-4">
            ...
            <a href="createform.jsp" class="flex items-center py-2 px-4  rounded mt-2" style="text-decoration: none ; color:white " id="menu">
                <span class="material-icons">add_circle</span> <span class="ml-2">Create Form</span>
            </a> 
            <a href="form_list.jsp" class="flex items-center py-2 px-4  rounded mt-2" id="menu" style="text-decoration: none ; color:white ">
